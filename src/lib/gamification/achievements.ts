...
export const ACHIEVEMENTS: Achievement[] = [
  ...
  CREATIVE("k_early_bird", "Early Bird", "Claim a daily bonus between 5 and 7 AM UTC.",
  ...
  CREATIVE("k_lucky_2500", "Jackpot!", "Win 2,500+ XP on the wheel.", (s) => s.wheelBest >= 2500, 0, 1000),
