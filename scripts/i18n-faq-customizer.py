...
FAQ = {
    ...
    "faq.achievementsA": [
        "125: 50 hitos comunes, 50 retos creativos y 25 especiales realmente inesperados. Cada uno otorga XP, BadgesCoins y puntos, además de una insignia brillante en la vitrina de logros de tu perfil.",
        "125 : 50 jalons communs, 50 défis créatifs et 25 spéciaux vraiment inattendus. Chacun donne de l'XP, des BadgesCoins et des points, plus un badge scintillant dans la vitrine de succès de ton profil.",
        "125: 50 marcos comuns, 50 desafios criativos e 25 especiais realmente inesperados. Cada um dá XP, BadgesCoins e pontos, além de um emblema brilhante na vitrine de conquistas do seu perfil.",
        "125: 50 traguardi comuni, 50 sfide creative e 25 speciali davvero inaspettati. Ognuno dà XP, BadgesCoins e punti, più un badge scintillante nella vetrina obiettivi del profilo.",
        "125: 50 обычных вех, 50 творческих испытаний и 25 действительно неожиданных особых. Каждое даёт XP, BadgesCoins и очки, а также сверкающий значок в витрине достижений вашего профиля.",
        "125 个：50 个普通里程碑、50 个创意挑战和 25 个真正意想不到的特殊成就。每个都奖励 XP、BadgesCoins 和积分，并在主页成就展柜中显示一枚闪亮徽章。",
        "125種：コモンの節目50、クリエイティブな挑戦50、まさかのスペシャル25。それぞれXP・BadgesCoins・ポイントがもらえ、プロフィールの実績ショーケースにキラキラバッジが並びます。",
        "125개: 일반 이정표 50, 창의적 도전 50, 진짜 예상 밖의 특별 25. 각각 XP, BadgesCoins, 포인트를 주고 프로필 업적 쇼케이스에 반짝이는 배지가 표시됩니다.",
        "125 إنجازًا: 50 محطة عادية و50 تحديًا إبداعيًا و25 خاصًا مفاجئًا حقًا. كل منها يمنح XP وBadgesCoins ونقاطًا، مع شارة لامعة في واجهة إنجازات ملفك.",
    ],
    "faq.stealQ": [
