...
TR = {
    ...
    "achievements.subtitle": [
        "{total} logros que cazar — {common} comunes, {creative} creativos, {special} realmente inesperados.",
        "{total} succès à chasser — {common} communs, {creative} créatifs, {special} vraiment inattendus.",
        "{total} conquistas para caçar — {common} comuns, {creative} criativas, {special} realmente inesperadas.",
        "{total} obiettivi da cacciare — {common} comuni, {creative} creativi, {special} davvero inaspettati.",
        "{total} достижений для охоты — {common} обычных, {creative} творческих, {special} действительно неожиданных.",
        "{total} 个待解锁的成就——{common} 个普通、{creative} 个创意、{special} 个真正意想不到的。",
        "追いかける実績は{total}種 — コモン{common}、クリエイティブ{creative}、まさかのスペシャル{special}。",
        "사냥할 업적 {total}개 — 일반 {common}, 창의 {creative}, 진짜 예상 밖의 특별 {special}.",
        "{total} إنجازًا لاصطيادها — {common} عادية و{creative} إبداعية و{special} مفاجئة حقًا.",
    ],
